#This is to implement transfer Learning techniques
#For using vgg16
#similarly use resnet instead of vgg use resnet refer to keras 
...
#dataset in form of zip file in drive
...
vgg = VGG16(input_shape=IMAGE_SIZE + [3], weights='imagenet', include_top=False)#if grey white image use 1 instead of 3
